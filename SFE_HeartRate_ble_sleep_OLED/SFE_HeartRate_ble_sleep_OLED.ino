...
//Setup to sense a nice looking saw tooth on the plotter
  ...
  byte sampleAverage = 8; //Options: 1, 2, 4, 8, 16, 32 *smaller = noisier, bigger = slower, less bpm resolution
  byte ledMode = 2; //Options: 1 = Red only, 2 = Red + IR, 3 = Red + IR + Green *not a bad value? needs refinement
